...
def register_types(module):
    ...
    ## infdist-header.h (module 'network'): ns3::InfDistHeader [class]
    module.add_class('InfDistHeader', parent=root_module['ns3::Header'])
...
def register_methods(root_module):
    ...
    register_Ns3InfDistHeader_methods(root_module, root_module['ns3::InfDistHeader'])
...
def register_Ns3InfDistHeader_methods(root_module, cls):
    ## infdist-header.h (module 'network'): ns3::InfDistHeader::InfDistHeader(ns3::InfDistHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::InfDistHeader const &', 'arg0')])
    ## infdist-header.h (module 'network'): ns3::InfDistHeader::InfDistHeader() [constructor]
    cls.add_constructor([])
    ## infdist-header.h (module 'network'): uint32_t ns3::InfDistHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## infdist-header.h (module 'network'): char * ns3::InfDistHeader::GetData() [member function]
    cls.add_method('GetData', 
                   'char *', 
                   [])
    ## infdist-header.h (module 'network'): char ns3::InfDistHeader::GetDataType() [member function]
    cls.add_method('GetDataType', 
                   'char', 
                   [])
    ## infdist-header.h (module 'network'): ns3::TypeId ns3::InfDistHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## infdist-header.h (module 'network'): uint32_t ns3::InfDistHeader::GetSender() [member function]
    cls.add_method('GetSender', 
                   'uint32_t', 
                   [])
    ## infdist-header.h (module 'network'): uint32_t ns3::InfDistHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## infdist-header.h (module 'network'): uint64_t ns3::InfDistHeader::GetTimestamp() [member function]
    cls.add_method('GetTimestamp', 
                   'uint64_t', 
                   [])
    ## infdist-header.h (module 'network'): static ns3::TypeId ns3::InfDistHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## infdist-header.h (module 'network'): void ns3::InfDistHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## infdist-header.h (module 'network'): void ns3::InfDistHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## infdist-header.h (module 'network'): void ns3::InfDistHeader::SetData(uint16_t len, char * data) [member function]
    cls.add_method('SetData', 
                   'void', 
                   [param('uint16_t', 'len'), param('char *', 'data')])
    ## infdist-header.h (module 'network'): void ns3::InfDistHeader::SetDataType(char type) [member function]
    cls.add_method('SetDataType', 
                   'void', 
                   [param('char', 'type')])
    ## infdist-header.h (module 'network'): void ns3::InfDistHeader::SetSender(uint32_t sender) [member function]
    cls.add_method('SetSender', 
                   'void', 
                   [param('uint32_t', 'sender')])
    ## infdist-header.h (module 'network'): void ns3::InfDistHeader::SetTimestamp(uint64_t timestamp) [member function]
