...
def register_types(module):
    ...
    module.add_class('InfDistHeader', import_from_module='ns.network', parent=root_module['ns3::Header'])
...
def register_Ns3InfDistHeader_methods(root_module, cls):
    ...
    cls.add_method('Deserialize', 
                   ...
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## infdist-header.h (module 'network'): uint16_t ns3::InfDistHeader::GetData() const [member function]
    ...
    cls.add_method('Serialize', 
                   ...
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## infdist-header.h (module 'network'): void ns3::InfDistHeader::SetData(uint16_t data) [member function]
